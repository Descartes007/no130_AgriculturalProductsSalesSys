            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="农产品原价" prop="nongchanpinOldMoney">
                        <el-input v-model="nongchanpinForm.nongchanpinOldMoney"
                                  placeholder="农产品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="nongchanpinClicknum">
                        <el-input v-model="nongchanpinForm.nongchanpinClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="nongchanpinClicknum">
                            <el-input v-model="ruleForm.nongchanpinClicknum"
