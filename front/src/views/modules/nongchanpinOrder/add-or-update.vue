    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.nongchanpinPhoto" label="农产品照片" prop="nongchanpinPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (nongchanpinForm.nongchanpinPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.nongchanpinPhoto" label="农产品照片" prop="nongchanpinPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.nongchanpinPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="nongchanpinOrderPaymentTypes">
                        <el-select v-model="ruleForm.nongchanpinOrderPaymentTypes" :disabled="ro.nongchanpinOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in nongchanpinOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支付类型" prop="nongchanpinOrderPaymentValue">
                        <el-input v-model="ruleForm.nongchanpinOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    nongchanpinOrderUuidNumber: false,
                    addressId: false,
                    nongchanpinId: false,
                    yonghuId: false,
                    buyNumber: false,
                    ...
                    nongchanpinOrderPaymentTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    ...
                    nongchanpinOrderPaymentTypes: '',
                    insertTime: '',
                },
                nongchanpinOrderTypesOptions : [],
                nongchanpinOrderPaymentTypesOptions : [],
                addressOptions : [],
                nongchanpinOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=nongchanpin_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.nongchanpinOrderPaymentTypesOptions = data.data.list;
                    }
                });
